...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_market_data_cache_cache_key"), "market_data_cache", ["cache_key"], unique=True
    )
    op.create_index(
        op.f("ix_market_data_cache_expires_at"), "market_data_cache", ["expires_at"], unique=False
    )
    op.create_table(
        "reports",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_chat_messages_chat_session_id"), "chat_messages", ["chat_session_id"], unique=False
    )
